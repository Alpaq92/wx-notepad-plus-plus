...
// lmObjC (Don-Ho-modified LexCPP), lmSearchResult, lmUserDefine: Notepad++'s GPL/ambiguous
// custom lexers, removed for a permissive build (unused; LexCPP covers Objective-C).
