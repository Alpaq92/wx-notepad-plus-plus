...
| Toolbar icons — `resources/icons/` | **MIT** (+ Apache-2.0, see note) | Tabler © Paweł Kuna, Open Color © Heeyeun Jeong. **Except `wrap-selection.svg`**, which is original wxNote artwork under **Apache-2.0** — no Tabler glyph exists for the concept; see the pack's `CREDITS.md` |
| Colored toolbar icon option — `resources/icons-solar/` | **CC BY 4.0** (+ Apache-2.0, see note) | Solar Icons (Bold Duotone) © 480 Design, recoloured to Open Color green-8 / green-3. **Except `wrap-selection.svg`**, original wxNote artwork under **Apache-2.0** |
| Colored toolbar icon option — `resources/icons-iconpark/` | **Apache-2.0** | IconPark © ByteDance, recoloured to Open Color teal-7 / lime-5. `wrap-selection.svg` is original wxNote artwork rather than an IconPark glyph — same licence either way, but its provenance is recorded in the pack's `CREDITS.md` |
| Colored toolbar icon option — `resources/icons-streamline/` | **CC BY 4.0** (+ Apache-2.0, see note) | Free icons from [Streamline](https://streamlinehq.com) (Core flat set) © Streamline / Webalys, recoloured to Open Color green-4 / teal-8. **Except `wrap-selection.svg`**, original wxNote artwork under **Apache-2.0**, and not regenerated by `tools/generate_streamline_icons.py` |
