...
inline constexpr int kCmdEditCopyAsHtml                          = 42107;  // wxNote-only (N++'s NppExport is a plugin; no core IDM)
inline constexpr int kCmdEditCopyAsRtf                           = 42108;  // wxNote-only (N++'s NppExport is a plugin; no core IDM)
