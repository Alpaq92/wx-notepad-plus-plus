...
# Produces build/installer/wxnote_<version>_amd64.deb
set -euo pipefail
...
dpkg-deb --build --root-owner-group "$PKGDIR" "$OUTDIR/wxnote_${VERSION}_amd64.deb"
echo "Built $OUTDIR/wxnote_${VERSION}_amd64.deb"
