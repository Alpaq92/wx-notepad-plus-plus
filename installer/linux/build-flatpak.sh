#!/usr/bin/env bash
# Build a .flatpak single-file bundle from the wxnote build output. Run from the repo root after
# `cmake --build build --target wxnote`, with flatpak-builder installed and the
