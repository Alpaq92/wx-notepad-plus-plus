...
Already use Notepad++? wxNote will feel like home. It keeps the same fast, no-nonsense editing and a
familiar layout — the real difference is *where* it runs and *how* it's licensed. Here's the short,
...
| Familiar menus &amp; shortcuts | Yes | Yes |
